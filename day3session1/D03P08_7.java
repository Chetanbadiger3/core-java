package com.learning.corejava.day3session1;
	...
	public class D03P08_7 {
	    public static void main(String[] args) {
	        ...
	        Car maxPriceCar = carMap.lastKey();
	        System.out.println("Car with greatest price: " + maxPriceCar + " " + carMap.get(maxPriceCar));

	        // Retrieve the key-value mapping associated with the least price
	        Car minPriceCar = carMap.firstKey();
	        System.out.println("Car with least price: " + minPriceCar + " " + carMap.get(minPriceCar));
	    }
	}
